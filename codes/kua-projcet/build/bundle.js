...
/***/ function(module, exports, __webpack_require__) {
	...
	var Router = ReactRouter.Router, Route = ReactRouter.Route, IndexRoute = ReactRouter.IndexRoute, hashHistory = ReactRouter.hashHistory;
	var react_kua_1 = __webpack_require__(60);
	react_kua_1.tool;
	var HelloWorld_1 = __webpack_require__(78);
	ReactDOM.render((React.createElement(Router, { history: hashHistory },
	    React.createElement(Route, { path: '/', component: HelloWorld_1.HelloWorld }))), document.getElementById('root'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var tool_1 = __webpack_require__(61);
	exports.tool = tool_1.tool;
	var r = tool_1.tool.r, lr = tool_1.tool.lr;
	exports.r = r;
	exports.lr = lr;
	...
	var ListView_1 = __webpack_require__(67);
	exports.ListView = ListView_1.ListView;
	var RecyclerView_1 = __webpack_require__(68);
	exports.RecyclerView = RecyclerView_1.RecyclerView;
	var RefreshControl_1 = __webpack_require__(69);
	exports.RefreshControl = RefreshControl_1.RefreshControl;
	var ScrollView_1 = __webpack_require__(70);
	exports.ScrollView = ScrollView_1.ScrollView;
	var Slider_1 = __webpack_require__(71);
	exports.Slider = Slider_1.Slider;
	var Switch_1 = __webpack_require__(72);
	exports.Switch = Switch_1.Switch;
	var Text_1 = __webpack_require__(73);
	exports.Text = Text_1.Text;
	var TextInput_1 = __webpack_require__(74);
	exports.TextInput = TextInput_1.TextInput;
	var Video_1 = __webpack_require__(75);
	exports.Video = Video_1.Video;
	var View_1 = __webpack_require__(76);
	exports.View = View_1.View;
	var YmUIKit = {
	    tool: tool_1.tool, r: r, lr: lr,
	    Button: Button_1.Button,
	    Image: Image_1.Image,
	    Index: Index_1.Index,
	    Layer: Layer_1.Layer,
	    Link: Link_1.Link,
	    ListView: ListView_1.ListView,
	    RecyclerView: RecyclerView_1.RecyclerView,
...
/***/ function(module, exports) {
	...
	exports.tool = {
	    ...
	    //func
	    changePc: function () {
	        exports.tool.pc = exports.tool.w > 750 ? true : false;
	    },
	    setRem: function (designWidth) {
	        if (!designWidth)
	            designWidth = 750;
	        var autoSize = 1;
	    ...
	    setPhoneText: function (obj) {
	        if (!exports.tool.pc) {
	            obj['-webkit-tap-highlight-color'] = 'transparent';
	            obj['-webkit-touch-callout'] = 'none';
	        }
	    },
	    setPhoneInput: function (obj) {
	        if (!exports.tool.pc) {
	        }
	    },
	    setFlexd: function (obj) {
	        var flexCss = {
	            position: 'fixed',
	            zIndex: 999,
	        };
	        obj = exports.tool.assign(obj, flexCss);
	    },
	    toFixed: function (obj, num) {
	        var n = obj.toFixed(1);
	        return n;
	    },
	...
	if (exports.tool.created === false) {
	    exports.tool.autoSize = exports.tool.setRem();
	    exports.tool.onload();
	    exports.tool.changePc();
	    exports.tool.created = true;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Button = (function (_super) {
	    ...
	    Button.prototype.shouldComponentUpdate = function () { return true; };
	    Button.prototype.componentWillUpdate = function () { };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Image = (function (_super) {
	    ...
	    Image.prototype.shouldComponentUpdate = function () { return true; };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Index = (function (_super) {
	    ...
	    function Index(props) {
	        ...
	        _this.shouldComponentUpdate = function () { return true; };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Layer = (function (_super) {
	    ...
	    Layer.prototype.shouldComponentUpdate = function () { return true; };
	    Layer.prototype.componentWillUpdate = function () { };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Link = (function (_super) {
	    ...
	    Link.prototype.componentWillReceiveProps = function (nextProps) { };
	    Link.prototype.shouldComponentUpdate = function () { return true; };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ListView = (function (_super) {
	    ...
	    ListView.prototype.shouldComponentUpdate = function () { return true; };
	    ListView.prototype.componentWillUpdate = function () { };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RecyclerView = (function (_super) {
	    ...
	    RecyclerView.prototype.componentWillMount = function () { };
	    RecyclerView.prototype.render = function () {
	        return (React.createElement("div", __assign({}, this.props), this.props.children));
	    };
	    RecyclerView.prototype.componentDidMount = function () { };
	    RecyclerView.prototype.componentWillReceiveProps = function (nextProps) { };
	    RecyclerView.prototype.shouldComponentUpdate = function () { return true; };
	    RecyclerView.prototype.componentWillUpdate = function () { };
	    RecyclerView.prototype.componentWillUnmount = function () { };
	    return RecyclerView;
	}(React.Component));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RefreshControl = (function (_super) {
	    ...
	    RefreshControl.prototype.componentWillMount = function () { };
	    RefreshControl.prototype.render = function () {
	        return (React.createElement("div", __assign({}, this.props), this.props.children));
	    };
	    RefreshControl.prototype.componentDidMount = function () { };
	    RefreshControl.prototype.componentWillReceiveProps = function (nextProps) { };
	    RefreshControl.prototype.shouldComponentUpdate = function () { return true; };
	    RefreshControl.prototype.componentWillUpdate = function () { };
	    RefreshControl.prototype.componentWillUnmount = function () { };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ScrollView = (function (_super) {
	    ...
	    ScrollView.prototype.componentWillReceiveProps = function (nextProps) { };
	    ScrollView.prototype.shouldComponentUpdate = function () { return true; };
	    ScrollView.prototype.componentWillUpdate = function () { };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Slider = (function (_super) {
	    ...
	    Slider.prototype.shouldComponentUpdate = function () { return true; };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Switch = (function (_super) {
	    ...
	    Switch.prototype.shouldComponentUpdate = function () { return true; };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Text = (function (_super) {
	    ...
	    function Text(props) {
	        ...
	        _this.css = {};
	        //
	        _this.combProps = function (props) {
	            var style = props.style, rest = __rest(props, ["style"]);
	            _this.rest = rest;
	            if (!tool_1.tool.pc) {
	                _this.css = tool_1.tool.assign(_this.css, style);
	            }
	            else {
	                _this.css = style;
	            }
	        ...
	        _this.state = {};
	        tool_1.tool.setPhoneText(_this.css);
	        _this.combProps(_this.props);
	        return _this;
	    }
	    Text.prototype.componentWillMount = function () { };
	    Text.prototype.render = function () {
	        return (React.createElement(Layer_1.Layer, __assign({ style: this.css }, this.rest), this.props.children));
	    };
	    Text.prototype.componentDidMount = function () { };
	    Text.prototype.componentWillReceiveProps = function (nextProps) {
	        this.combProps(nextProps);
	    };
	    Text.prototype.shouldComponentUpdate = function () { return true; };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TextInput = (function (_super) {
	    ...
	    TextInput.prototype.componentWillMount = function () { };
	    TextInput.prototype.render = function () {
	        return (React.createElement("div", __assign({}, this.props), this.props.children));
	    };
	    TextInput.prototype.componentDidMount = function () { };
	    TextInput.prototype.componentWillReceiveProps = function (nextProps) { };
	    TextInput.prototype.shouldComponentUpdate = function () { return true; };
	    TextInput.prototype.componentWillUpdate = function () { };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Video = (function (_super) {
	    ...
	    Video.prototype.shouldComponentUpdate = function () { return true; };
	    Video.prototype.componentWillUpdate = function () { };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var View = (function (_super) {
	    ...
	    function View(props) {
	        ...
	        _this.state = {};
	        tool_1.tool.setPhoneView(_this.css);
	        _this.combProps(_this.props);
	        return _this;
	    }
	...
	var HelloWorld = (function (_super) {
	    ...
	    function HelloWorld(props) {
	        ...
	        _this.titleCss = {
	            ...
	            lineHeight: '2.64rem',
	            color: '#fff',
	            fontFamily: react_kua_1.tool.fontFamily,
	        };
	        _this.tipCss = {
	            textAlign: 'center',
	            fontSize: '0.24rem',
	    ...
	    HelloWorld.prototype.render = function () {
	        return (React.createElement(react_kua_1.Layer, __assign({ style: this.bgCss }, this.props),
	            React.createElement(react_kua_1.View, { style: this.titleCss }, "Hello Kua."),
	            React.createElement(react_kua_1.Text, { style: this.tipCss }, "Web is a natural cross platform"),
	            this.props.children));
	    };
	    return HelloWorld;
	}(React.Component));
